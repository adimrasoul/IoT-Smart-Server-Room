...
class checkingThreshold(object):
    ...
    def loadFile(self):
        try:
            ...
            print("* CheckingHumidity: ERROR IN CONNECTING TO THE SERVER FOR GETTING WEB SERVICE IP *")
        try:
            ...
            print("* CheckingHumidity: ERROR IN CONNECTING TO THE SERVER FOR READING initial_data.JSON *")
        return
    def gettingHum(self):
        ...
        try:
            ...
            print("* CheckingHumidity: ERROR IN GETTING DATA FROM WEB SERVICE *")
        return
