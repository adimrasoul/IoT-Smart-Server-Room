...
class checkingThreshold(object):
    ...
    def loadFile(self):
        try:
            ...
            print("* CheckingTemperature: ERROR IN CONNECTING TO THE SERVER FOR GETTING WEB SERVICE IP *")
        try:
            ...
            print("* CheckingTemperature: ERROR IN CONNECTING TO THE SERVER FOR READING initial_data.JSON *")
        return
    def gettingTemp(self):
        ...
        try:
            ...
            print("* CheckingTemperature: ERROR IN GETTING DATA FROM WEB SERVICE *")
        return
    ...
    def publishOrder(self):
        ...
        try:
            ...
            getTime = datetime.datetime.now()
            currentTime = getTime.strftime("%Y-%m-%d %H:%M:%S")
            print("* CheckingTemperature: ERROR IN PUBLISHING THE DATA *")
            print("at time: " + str(currentTime))
        return
